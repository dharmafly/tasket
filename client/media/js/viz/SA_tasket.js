require.def('tasket/SA_tasket', ['kgd/core', 'kgd/consts', 'kgd/world/World','kgd/world/Thing',  'kgd/simpleApp/SimpleApp', /*'kgd/maths/v2',*/ 'data/ff_data.js', 'tasketter.js', 'vec2.js'], function(core, consts, World, Thing, SimpleApp/*, v2*/){
	//vec2 = v2.vec2;
