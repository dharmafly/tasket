...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hub.private'
        db.delete_column('tasks_hub', 'private')

        # Adding field 'Hub.private_to'
        db.add_column('tasks_hub', 'private_to', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='private_hubs', null=True, blank=True, to=orm['tasks.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Hub.private'
        db.add_column('tasks_hub', 'private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Hub.private_to'
        db.delete_column('tasks_hub', 'private_to_id')
    ...
    models = {
        ...
        'tasks.hub': {
            ...
            'archived_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'archived_hubs'", 'null': 'True', 'to': "orm['tasks.Profile']"}),
            ...
            'private_to': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'private_hubs'", 'null': 'True', 'blank': 'True', 'to': "orm['tasks.Profile']"}),
